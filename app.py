...
with kpi3:
    st.metric("Average Value", f"{average_order_value:,.0f}")
...
with col1:
    ...
    fig1.update_traces(textfont_color= "Red", textposition = "outside")
...
with col2:
    ...
    fig2.update_traces(textfont_color= "Blue", textposition = "outside")
...
with col3:
    fig3 = px.bar(
        ...
        x= "ProductName",
        y= "TotalSales",
        title="Top 5 Prouducts",
        text_auto = '.2s'
    )
    fig3.update_traces(textfont_color= "Red", textposition = "outside")
